...
class OperationHandlerConfiguration {
    ...
    private() {
        return new OperationHandlerConfiguration(this.name, true, this.validation, this.globalConfiguration);
    }
    addInputValidation(inputValidationSetup) {
        ...
        return new OperationHandlerConfiguration(this.name, this.isPrivate, O.some(newValidation), O.none);
    }
    withGlobalConfiguration(operationGlobalConfig) {
        return new OperationHandlerConfiguration(this.name, this.isPrivate, this.validation, O.some(operationGlobalConfig));
    }
    ...
    usingHttp(httpSetup) {
        return new OperationHandler(this.name, this.isPrivate, this.validation, httpSetup(new HttpOperationHandler_1.HttpOperationHandlerConfiguration()), this.globalConfiguration);
    }
    usingComposite(compositeFunction) {
        return new OperationHandler(this.name, this.isPrivate, this.validation, new CompositeOperationHandler_1.CompositeOperationHandler(compositeFunction), O.none);
    }
}
