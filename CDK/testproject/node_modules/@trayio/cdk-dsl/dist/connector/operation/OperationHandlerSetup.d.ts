...
export declare class OperationHandler<AUTH extends OperationHandlerAuth<unknown, unknown>, IN, OUT> {
    ...
    constructor(name: string, isPrivate: boolean, validation: O.Option<OperationHandlerValidation<AUTH, IN, OUT>>, implementation: OperationHandlerImplementation<AUTH, IN, OUT>, globalConfiguration: O.Option<OperationGlobalConfigHttp<AUTH>>);
}
