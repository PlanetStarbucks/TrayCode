...
export declare class HttpOperationExecutionFactory {
    ...
    executionFrom<AUTH extends OperationHandlerAuth<unknown, unknown>, IN, OUT>(handler: HttpOperationHandler<AUTH, IN, OUT>, globalConfiguration: O.Option<OperationGlobalConfigHttp<AUTH>>): OperationExecution<AUTH, IN, OUT>;
}
