...
const input = {
	workfront_documents: [
		{
			...
			userID: null,
			downloadURL: "/internal/document/download?ID=64358d4a001bea8013d94c57301413d8",
			parameterValues: {},
			versions: [
				{
					...
					objCode: "DOCV",
					ext: "pdf",
					fileName: "1_64358d4a001bea8013d94c57301413d8_Client edits_Construction_Checklist_179326_B",
		...
		},
		{
			...
			userID: null,
			downloadURL: "/internal/document/download?ID=6418b8d8000d143379e6108c3e88b4df",
			parameterValues: {},
			versions: [
				{
	...
	config: {
		...
		meta_mappings: [
			{
				workfrontMetadata: '{"name":"referenceNumber","objectType":"document_standard","propertyType":"int"}',
				bynderMetaproperty: '{"id":"57BCEF85-FDF3-46FC-B390F00CD416535F","name":"Project_Number","type":"multiselect","editable":"true"}',
			},
		],
		subDomain: "fccfac.my",
	},
